...
namespace HumanityAgainstCards.Entities
{
    ...
    {
        // these questions and answers are dumped from a text file at: https://github.com/ormesam/against-humanity

        #region Card Text Dump

        private string questionTxtDump = @"_?  There's an app for that.
...
Lifetime&copy; presents _, the story of _.
...
_ ain't nothin' to fuck wit'!";
        ...
        private string answersTxtDump = @"Flying sex snakes.
